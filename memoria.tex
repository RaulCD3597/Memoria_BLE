...
En la presente memoria se describe el desarrollo de un sistema de llamado a
enfermera para la empresa SURIX S.R.L., basado en comunicación por
Bluetooth, que reemplazará al actual, basado en comunicación cableada. El
sistema desarrollado consiste en un dispositivo llamador, que se conecta con
una terminal de sala y puede enviar solicitudes del paciente, así como informar
el estado de su batería de alimentación. La terminal de sala debe recibir estos
mensajes y reenviarlos a la terminal de enfermería, y si es necesario iniciar una

llamada entre el paciente y la enfermera.

Para el desarrolo de esta aplicación se utilizaron conocimientos relacionados a
programacion de microcontroladores, protocolos de comunicación, sistemas
operativos en tiempo real, testing de software y desarrollo de aplicaciones.
