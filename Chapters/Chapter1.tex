...
Entre los productos ofertados por SURIX, se destaca el sistema de llamado a enfermera, este consta de un dispositivo llamador, que se conecta por cable a una central de sala, y ésta a su vez se conecta a través de una red a la terminal de enfermería \cite{helpip}.
